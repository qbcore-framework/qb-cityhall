...
$('.cityhall-option-block').click(function(e){
    ...
    if (blockPage == "identity") {
        ...
        $.post(`https://${GetParentResourceName()}/requestLicenses`, JSON.stringify({}), function(licenses){
...
$(".request-identity-button").click(function(e){
    ...
    $.post(`https://${GetParentResourceName()}/requestId`, JSON.stringify({
...
$(document).on('click', '.apply-job-button', function(e){
    ...
    $.post(`https://${GetParentResourceName()}/applyJob`, JSON.stringify({
        job: selectedJobId
    }))
